...
if ($action === 'to-response-demo-302') {
    header('Location: /pages//response', true, 302);
    exit;
}

if ($action === 'to-query-demo-301') {
    header('Location: /pages//query', true, 301);
    exit;
}
...
<ul>
    <li><a href="/redirect?action=to-home-302">302 redirect to /</a></li>
    <li><a href="/redirect?action=to-response-demo-302">302 redirect to response demo</a></li>
    <li><a href="/redirect?action=to-query-demo-301">301 redirect to query demo</a></li>
</ul>
...
<form method="post" action="/redirect-handler">
    <label>
